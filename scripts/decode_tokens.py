...
def main(
    ...
    runner.decode_and_save_pdbs(
        ...
        quantization_levels=cfg.model.model.codebook.levels,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--codebook_size", type=int, choices=[4094, 64000], default=4096)
    ...
    model_config = f"gnn/ablation_{codebook_size}_df_{df}.yaml"
